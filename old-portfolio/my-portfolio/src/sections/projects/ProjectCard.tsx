...
const ProjectCard: React.FC<ProjectCardProps> = ({ 
  ...
  return (
    <motion.div 
      className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden border border-white/20 hover:border-cyan-400/50 transition-all duration-300 group"
      whileHover={{ 
        y: -10, 
        scale: 1.02,
      ...
      <div className="p-6">
        ...
        <div className="flex gap-4">
          <motion.a 
            ...
            className="flex-1 text-center py-2 px-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-sm font-semibold rounded-lg hover:from-cyan-400 hover:to-blue-500 transition-all duration-300 shadow-lg hover:shadow-cyan-500/25"
